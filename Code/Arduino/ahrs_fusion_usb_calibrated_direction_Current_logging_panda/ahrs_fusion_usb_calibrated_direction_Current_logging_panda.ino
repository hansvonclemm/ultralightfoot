...
float mag_offsets[3]            = { 10.14F, 6.04F, 57.42F };

// Soft iron error compensation matrix
float mag_softiron_matrix[3][3] = { {  1.043,  -0.081,  0.026 },
                                    {  -0.082,  0.948, 0.029 },
                                    {  0.026, 0.028,  1.026 } };

float mag_field_strength        = 36.23F;
...
//  Serial.println(roll);
    ...
    String dataString = "Heading direction: ";
         dataString += heading;
         dataString += ",";
 
         dataString += "Inclination: ";
         dataString += pitch;

  // read three sensors and append to the string:
//  for (int analogPin = 20; analogPin < 22; analogPin++) {
...
dataString += ",";
dataString += "Panel A Voltage: ";
dataString += busvoltage;
dataString += ",";
dataString += "Panel A Current: ";
